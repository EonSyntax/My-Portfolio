...
# SECRET_KEY = 'django-insecure-)mlonhr@yqw23g(o2jk!uo)zbc-9*jk%(qzgycn1(+&)@$7r0p'
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-)mlonhr@yqw23g(o2jk!uo)zbc-9*jk%(qzgycn1(+&)@$7r0p')
...
# Media files (still define MEDIA_URL for template access)
MEDIA_URL = '/media/'
